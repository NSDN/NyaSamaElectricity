 ...
 */
public class BlockWire extends BlockRailBase implements ITileEntityProvider {
    ...
    public class Rail extends BlockRailBase.Rail
    {
        ...
        {
            return world.getBlock(x, y, z).getClass() == BlockWire.class;
        }
        ...
        public void func_150655_a(boolean p_150655_1_, boolean p_150655_2_)
        {
            ...
            if (p_150655_2_ || this.world.getBlockMetadata(this.chunkCoordX, this.chunkCoordY, this.chunkCoordZ) != i)
            {
                ...
                {
                    BlockWire.Rail rail = this.func_150654_a((ChunkPosition)this.array.get(j));
                    if (rail != null)
                    {
                        rail.func_150651_b();
