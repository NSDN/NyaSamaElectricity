 ...
 */
public class CableNode extends SignalBox {

    public static class TileEntityCableNode extends SignalBox.TileEntitySignalBox {
    ...
    public CableNode() {
        super(NyaSamaElectricity.MODID, "CableNode", "cable_node");
        setHardness(2.0F);
