...
public class TileEntityHVDangerSignA extends TileEntityBase {

    public static class HVDangerSignA extends TileEntity {
    }

    public TileEntityHVDangerSignA() {
        super("HVDangerSignA");
        setIconLocation("hv_danger_sign_a");
    }

    @Override
    public TileEntity createNewTileEntity(World world, int meta) {
        return new HVDangerSignA();
    }
