...
public class TileEntityWire extends BlockRailBase implements ITileEntityProvider {
    ...
    public class Rail extends BlockRailBase.Rail
    {
        ...
        {
            return world.getBlock(x, y, z).getClass() == TileEntityWire.class;
        }
        ...
        private void func_150651_b()
        {
            ...
            {
                TileEntityWire.Rail rail = this.func_150654_a((ChunkPosition)this.array.get(i));
        ...
        protected TileEntityWire.Rail func_150654_a(ChunkPosition chunkPosition)
        {
        ...
        //WTF?
        private boolean func_150653_a(TileEntityWire.Rail p_150653_1_)
        {
            for (int i = 0; i < this.array.size(); ++i)
            {
        ...
        {
            TileEntityWire.Rail rail = this.func_150654_a(new ChunkPosition(p_150647_1_, p_150647_2_, p_150647_3_));
        ...
        public void func_150655_a(boolean p_150655_1_, boolean p_150655_2_)
        {
            ...
            if (p_150655_2_ || this.world.getBlockMetadata(this.chunkCoordX, this.chunkCoordY, this.chunkCoordZ) != i)
            {
                ...
                {
                    TileEntityWire.Rail rail = this.func_150654_a((ChunkPosition)this.array.get(j));
                    if (rail != null)
                    {
                        rail.func_150651_b();
